...
# Step 1
# path = '/Users/albert/Downloads/data/new_power/3_payload_current/temp/stepc_auto_rearranged_data.csv'
# df = pd.read_csv(path)
# rounds = find_all_rounds(df)

# Step 2-A
# Assuming rounds is your list of rounds
# longest_rounds = find_longest_continuous_rounds(rounds)
# print(longest_rounds)  # This will output the longest continuous rounds

# Step 2-B
# all_rounds = get_all_rounds(df)
# common_rounds = find_common_rounds(all_rounds)
# print('Dates of the most common round:', common_rounds)

# Step 3
# energy_df = calculate_energy(df, common_rounds)
# energy_df.to_csv('common_rounds_energy_df.csv', index=False)
# print(energy_df.iloc[0])
# print(energy_df.iloc[36])
# print(energy_df.iloc[153])
# print(energy_df.iloc[160])
